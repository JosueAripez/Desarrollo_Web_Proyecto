<%-- 
    Document   : Chile-morron
    Created on : 19 may 2024, 14:15:58
    Author     : jossu
--%>
        ...
        <table>
            <tr>
                        ...
                        <div class="carousel__contenedor">
                            ...
                            <div class="carousel__lista">
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/Chile_morron.jpg" alt="chile morron">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/chile_morron_1.jpg" alt="chile morron">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/chile_morron_2.jpg" alt="chile morron">
                                </div>
                ...
                <td class="product-info">
                    <h2 class="product-name">Chile Morron</h2>
