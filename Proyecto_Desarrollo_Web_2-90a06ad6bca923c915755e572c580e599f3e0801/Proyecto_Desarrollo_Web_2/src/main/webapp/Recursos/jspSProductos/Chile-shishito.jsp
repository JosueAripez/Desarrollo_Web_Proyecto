<%-- 
    Document   : Menta
    Created on : 19 may 2024, 14:17:15
    Author     : jossu
--%>
        ...
        <table>
            <tr>
                        ...
                        <div class="carousel__contenedor">
                            ...
                            <div class="carousel__lista">
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/shishito-1.jpg" alt="shishito">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/shishito-2.jpeg" alt="shishito">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/shishito-3.jpg" alt="shishito">
                                </div>
                ...
                <td class="product-info">
                    <h2 class="product-name">Chile Shishito</h2>
                    <p>
                        Los deliciosos pimientos Shishito son vegetales muy nutritivos y están llenos de vitaminas y minerales<br>
                        que sonnecesarios para mantener una alimentación balanceada y llevar un estilo de vida saludable.
                    </p>
                </td>
            </tr>
        </table>
