<%-- 
    Document   : Chile-wero
    Created on : 19 may 2024, 14:16:12
    Author     : jossu
--%>
        ...
        <table>
            <tr>
                ...
                <td class="product-info">
                    ...
                    <p>
                        Chile Güero o Xcatic. Este chile es muy utilizado en la gastronomía de la Peninsula de Yucatán.<br>
                        Tiene un picor medio, y se utiliza de muchas maneras.
                    </p>
                </td>
            </tr>
        </table>
        ...
        <table id="Detalles-producto">
            ...
            <tbody>
                ...
                <tr>
                    <td>Comentarios</td>
                    <td>
                        Excelente color, excelente estetica de fruta, pared gruesa, buen tamaño
                    </td>
                </tr>
