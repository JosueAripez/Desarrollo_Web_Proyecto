<%-- 
    Document   : Ejote
    Created on : 19 may 2024, 14:16:29
    Author     : jossu
--%>
        ...
        <table>
            <tr>
                        ...
                        <div class="carousel__contenedor">
                            ...
                            <div class="carousel__lista">
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/ejote_1.jpg" alt="ejote">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/ejote_2.jpg" alt="ejote">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/ejote_3.jpg" alt="ejote">
                                </div>
                ...
                <td class="product-info">
                    ...
                    <p>
                        Requiere de suelos fértiles, con alto contenido de materia orgánica y franco arcilloso limoso, profundo,<br>
                        con buen drenaje. Temperaturas entre los 14 a 28 C.
                    </p>
                </td>
            </tr>
        </table>
        ...
        <table id="Detalles-producto">
            ...
            <tbody>
                ...
                <tr>
                    <td>Comentarios</td>
                    <td>
                        Excelente color, buen amarre, planta fuerte
                    </td>
                </tr>
