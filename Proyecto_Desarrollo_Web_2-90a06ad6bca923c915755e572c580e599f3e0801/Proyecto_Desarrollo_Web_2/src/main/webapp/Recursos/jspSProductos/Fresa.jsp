<%-- 
    Document   : Fresa
    Created on : 19 may 2024, 14:16:47
    Author     : jossu
--%>
                        ...
                        <div class="carousel__contenedor">
                            ...
                            <div class="carousel__lista">
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/Fresa.jpg" alt="fresa">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/About/fresas.png" alt="fresa">
                                </div>
                                <div class="carousel__elemento">
                                    <img src="../Imgs/Productos/fresa_1.jpg" alt="fresa">
                                </div>
