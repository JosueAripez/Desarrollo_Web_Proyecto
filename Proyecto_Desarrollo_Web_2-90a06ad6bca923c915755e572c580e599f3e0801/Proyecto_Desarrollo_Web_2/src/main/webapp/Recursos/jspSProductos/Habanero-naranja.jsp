            ...
            <table>
                <tr>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Chile Habanero Naranja</h2>
                        <p>
                            El Habanero Orange es uno de los mejores chiles, con un color lleno y brillante como el albaricoque;<br>
                            pertenece a la familia Capsicum Chinense, como el tabaco, las bayas goji, los tomates y las patatas.
                        </p>
                    </td>
                </tr>
            </table>
