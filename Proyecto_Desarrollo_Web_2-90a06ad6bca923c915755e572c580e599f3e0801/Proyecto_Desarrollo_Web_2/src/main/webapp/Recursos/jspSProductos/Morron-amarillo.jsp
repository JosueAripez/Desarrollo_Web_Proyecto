            ...
            <table>
                <tr>
                            ...
                            <div class="carousel__contenedor">
                                <div class="carousel__lista">
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/ama.jpeg" alt="ama">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/ama2.jpeg" alt="ama">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/ama3.jpg" alt="ama">
                                    </div>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Pimiento Morron Amarillo</h2>
                        <p>
                            El pimiento contiene vitaminas, minerales y antioxidantes. Fortalecen el sistema inmunológico y a evitar<br>
                            las enfermedades cardiacas. Ayuda a bajar de peso ya que tiene un contenido calórico muy bajo y alto<br>
                            contenido de fibra, lo cual produce saciedad y ayuda a la digestión.
                        </p>
                    </td>
                </tr>
            </table>
