            ...
            <table>
                <tr>
                            ...
                            <div class="carousel__contenedor">
                                <div class="carousel__lista">
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/anaranjado.jpeg" alt="naranja">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/naranja2.png" alt="naranja">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/naranja3.jpeg" alt="naranja">
                                    </div>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Pimiento Morron Naranja</h2>
                        <p>
                            El Chile Pimiento Morrón Naranja Kg puede usarse como una deliciosa especia o un complemento de<br>
