        ...
        <div class="nav">
            ...
            <table>
                <tr>
                            ...
                            <div class="carousel__contenedor">
                                <div class="carousel__lista">
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/serrano.jpg" alt="serrano">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/serrano2.jpg" alt="serrano">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/serrano3.jpeg" alt="serrano">
                                    </div>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Chile Serrano</h2>
                        <p>
                            También conocido como chile verde, es una variedad de chile de origen y consumo en México, caracterizado por<br>
                            ser pequeño, de forma cilíndrica y a veces terminado en punta. Se considera picante, y generalmente se acompaña<br>
                            con sus semillas y venas, también muy picantes.
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Comentarios</td>
                    <td>
                        Excelente color, planta fuerte, buen cuaje, excelente picor
                    </td>
                </tr>
