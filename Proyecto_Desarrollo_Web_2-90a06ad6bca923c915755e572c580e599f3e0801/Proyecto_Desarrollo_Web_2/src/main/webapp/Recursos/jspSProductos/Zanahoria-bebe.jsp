        ...
        <div class="nav">
            ...
            <table>
                <tr>
                            ...
                            <div class="carousel__contenedor">
                                <div class="carousel__lista">
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/bebe.jpg" alt="bebe">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/bebe2.jpg" alt="bebe">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/beeb3.jpg" alt="bebe">
                                    </div>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Zanahoria Bebe</h2>
                        <p>
                            Una zanahoria baby es una zanahoria cosechada antes de alcanzar la madurez y vendida en ese tamaño<br>
                            más pequeño. Una zanahoria baby-cut es un trozo pequeño cortado de una zanahoria más grande.
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Comentarios</td>
                    <td>
                        Buena germinación, color uniforme, excelente
                        opción para proceso y bolsa
                    </td>
                </tr>
