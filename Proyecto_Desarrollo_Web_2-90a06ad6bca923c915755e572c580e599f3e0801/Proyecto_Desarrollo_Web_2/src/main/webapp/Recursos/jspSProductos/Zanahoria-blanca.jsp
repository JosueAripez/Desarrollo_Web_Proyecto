            ...
            <table>
                <tr>
                            ...
                            <div class="carousel__contenedor">
                                <div class="carousel__lista">
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/blanca.jpg" alt="blanca">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/blanca2.jpg" alt="blanca">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/blanca3.jpg" alt="blanca">
                                    </div>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Zanahoria Blanca</h2>
                        <p>
                            La arracacha también conocida como arracache, apio criollo, racacha, virraca, zanahoria blanca o<br>
                            mandioquiña salsa es una planta cuyo tubérculo es alimenticio, originaria de los Andes y cultivada<br>
                            actualmente en Bolivia, Costa Rica, Colombia, Brasil, Perú, Venezuela y Ecuador.
                        </p>
                    </td>
                </tr>
            </table>
