            ...
            <table>
                <tr>
                            ...
                            <div class="carousel__contenedor">
                                <div class="carousel__lista">
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/morada.jpg" alt="morada">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/morada2.jpeg" alt="morada">
                                    </div>
                                    <div class="carousel__elemento">
                                        <img src="../Imgs/Productos/morada3.jpg" alt="morada">
                                    </div>
                    ...
                    <td class="product-info">
                        <h2 class="product-name">Zanahoria Morada</h2>
                        <p>
                            Las zanahorias moradas proceden, como otras variedades cultivadas de diferentes colores, de la<br>
                            zanahoria silvestre. Mientras que las zanahorias claras fueron seleccionadas en Asia Menor<br>
                            (principalmente Turquía), las variedades moradas provienen de Asia central.
                        </p>
                    </td>
                </tr>
            </table>
